...
const META: Record<string, Meta> = {
  ...
  "Data Engineering": { tile: "tile-data", icon: FiDatabase, accent: "#22C55E", glow: "34,197,94" },
  Programming: { tile: "tile-prog", icon: FiCode, accent: "#38BDF8", glow: "56,189,248" },
      ...
      <div className="skills-container">
        ...
        <div className="skills-bento">
          {skillGroups.map((group) => {
            const meta = META[group.label] ?? FALLBACK;
            ...
            return (
              ...
              >
                <div className="skill-tile-head">
                  ...
                  <span className="skill-tile-label">{group.label}</span>
                </div>
